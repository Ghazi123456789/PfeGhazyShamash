...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("tn.dpc.gestion.des.ressources.humaine.Controllers"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo(
                ...
                "2.0",
                "Terms of service",
                new Contact("Ahmed Homrani", "lien github", "aymen.zaabar@esprit.tn"),
                "License of API",
                "API license URL",
